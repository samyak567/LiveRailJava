...
//-----------------------------------------------------------------------------------Live Train status------------------------------------------------------------------------------------------------------
	...
	/*
	 * @GetMapping("/liveTrain") ModelAndView goToLiveTrainForm() { return new
	 * ModelAndView("rail/liveTrainForm"); }
	 */
	
	@GetMapping("/liveTrain")
	ResponseEntity<String> getLiveTrainStatus(@RequestParam String trainNo, @RequestParam String date) {
		...
		return ResponseEntity.ok().body(result)	;	//returning ModelAndView Object
	}
	
//-----------------------------------------------------------------------------------Live Station Info------------------------------------------------------------------------------------------------------
	
	/*
	 * @GetMapping("/liveStation") ModelAndView goToLiveStationForm() { return new
	 * ModelAndView("rail/liveStationForm"); }
	 */
	
	@GetMapping("/liveStation")
	ResponseEntity<String>  getLiveStationInfo(@RequestParam String stationCode) {
		...
		if(result == null) {
			...
			System.out.println(trainArrayJSON);
...
//				e.printStackTrace();
//			}	
			return ResponseEntity.ok().body(trainArrayJSON);
		}
...
//---------------------------------------------------------------------------------Rescheduled Trains-------------------------------------------------------------------------------------------------------------------
	...
	public ResponseEntity<String> api() {
		...
		js.put("stationCode", "RTM");
		return ResponseEntity.ok().body(js.toString());
	}
